...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="databuku.php" class="active">Kelola Data Buku</a>
    ...
    <div class="main-content">
        ...
        <div class="header">
            <h1>Data Buku</h1>
            <p>Daftar seluruh koleksi buku yang tersedia di sistem perpustakaan.</p>
        </div>
            ...
            <table>
                ...
                <tbody>
                    <?php while($data = mysqli_fetch_assoc($query)) { ?>
                        <tr>
                            <td><?php echo htmlspecialchars($data['bukuid'] ?? $data['BukuID'] ?? ''); ?></td>
                            <td><?php echo htmlspecialchars($data['judul'] ?? $data['Judul'] ?? ''); ?></td>
                            <td><?php echo htmlspecialchars($data['penulis'] ?? $data['Penulis'] ?? ''); ?></td>
                            <td><?php echo htmlspecialchars($data['penerbit'] ?? $data['Penerbit'] ?? ''); ?></td>
                            <td><?php echo htmlspecialchars($data['tahunterbit'] ?? $data['TahunTerbit'] ?? ''); ?></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
